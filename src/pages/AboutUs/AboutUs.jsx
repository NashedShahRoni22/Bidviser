    ...
    <section className="">
      ...
      <div className="mx-5 md:container md:mx-auto py-10 md:py-20">
        <h1 className="md:text-3xl text-center font-semibold">
          Why choose <span className="text-[#6C5AF6]">NSRDEV</span> for your
          software needs?
        </h1>
        ...
        <p className="mt-8 md:mt-16 md:text-xl text-center">
          Collaborate with{" "}
          <span className="text-[#6C5AF6] font-semibold">NSRDEV</span> to
          transform your ideas into reality. Whether you need an engaging
          website, a dynamic web application, or a scalable e-commerce platform,
          we are here to turn your vision into a digital masterpiece. Elevate
          your online presence with{" "}
          <span className="text-[#6C5AF6] font-semibold">NSRDEV</span>, where
